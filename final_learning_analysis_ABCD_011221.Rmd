...
Significant group differences in learning across trials for errors, but not time, with worse learning for Dys.  Differences survive after controlling for age, sex, and IQ
```{r, echo=FALSE,warning = FALSE}
...
```{r, echo=FALSE,include=FALSE}
#### growth curve analysis on error-no effect
