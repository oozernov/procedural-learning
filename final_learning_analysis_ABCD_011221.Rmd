...
##VSL Slope Analysis 
(ZQ notes: the group difference analysis should refer to abcd_sl_analysis.pdf, both the linear models and the lmer models are available with trials entered as continuous variables)
```{r,echo=FALSE,warning = FALSE}
