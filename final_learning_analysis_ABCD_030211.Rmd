...
ggplot(data = rpPlot, aes(x=trial, y=mean, linetype = Subgroup))+
...
ggplot(data = mtTPlot, aes(x=trial, y=meanT, linetype = Subgroup))+
  geom_line() +geom_point()  +
...
```{r, echo=FALSE,warning = FALSE}
ggplot(data = mtEPlot, aes(x=trial, y=meanE, linetype = Subgroup))+
  geom_line() +geom_point()  +
