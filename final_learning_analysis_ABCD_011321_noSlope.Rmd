...
task_data<-d_all%>%ungroup%>%dplyr::select(IQ,WR,Vocabulary,PA,Nonword,DigitsSpan,slopeProp_On,slope_mt,slope_me,vis_slope_scale,aud_slope_scale,aud_fam_rt,vis_fam_rt)

task_data<-d_all%>%ungroup%>%dplyr::select(IQ,WR,Vocabulary,PA,Nonword,DigitsSpan,slopeProp_On,slope_mt,slope_me,vis_slope_scale,aud_slope_scale,aud_fam_rt,vis_fam_rt)

task_data_dys<-d_all_dys%>%ungroup%>%dplyr::select(IQ,WR,Vocabulary,PA,Nonword,DigitsSpan,slopeProp_On,slope_mt,slope_me,vis_slope_scale,aud_slope_scale,aud_fam_rt,vis_fam_rt)

task_data_typ<-d_all_typ%>%ungroup%>%dplyr::select(IQ,WR,Vocabulary,PA,Nonword,DigitsSpan,slopeProp_On,slope_mt,slope_me,vis_slope_scale,aud_slope_scale,aud_fam_rt,vis_fam_rt)
