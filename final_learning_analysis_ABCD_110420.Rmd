...
mt_data$slope_me<-log(abs(mt_data$slope_mt)) #transform slope
...
task_data<-d_all%>%select(kbit_ss_2,wrmt_id_ss_2,wrmt_wa_ss_2,ctopp_nonword_raw_2,ctopp_elision_raw_2,ctopp_blending_raw_2,wais_dsb_ss_2,slopeProp_On_t,slope_mt_t,slope_me_t,vis_slope_scale,aud_slope_scale,quicksin_snr_loss_2)
